...
class BootStrap {
    ...
    def init = { servletContext ->
		// Administrateur
		User admin1 = new User(name: "adminustrator1Name", avatarUrl: "", mail: "adminustrator1Adresse@mail.com", password: "adminustrator1Password", admin: true)
		admin1.save()
		User admin2 = new User(name: "adminustrator2Name", avatarUrl: "/avatar/01.png",  mail: "adminustrator2Adresse@mail.com", password: "adminustrator2Password", admin: true)
		admin2.save()
		
		// Question Q1
		User userQ1 = new User(name: "userQ1Name", avatarUrl: "/avatar/02.png", mail: "userQ1Adresse@mail.com", password: "userQ1Password")
		userQ1.save()
		...
		questionQ1.save()
				...
				tagQ1T2.save()
				// Commentaire Q1C1
				User userQ1C1 = new User(name: "userQ1C1Name",avatarUrl: "/avatar/03.png", mail: "userQ1C1Adresse@mail.com", password: "userQ1C1Password")
				userQ1C1.save()
				...
				// Commentaire Q1C2
				User userQ1C2 = new User(name: "userQ1C2Name", avatarUrl: "/avatar/04.jpg", mail: "userQ1C2Adresse@mail.com", password: "userQ1C2Password")
				userQ1C2.save()
			...
			// Reponse Q1R1
			User userQ1R1 = new User(name: "userQ1R1Name", avatarUrl: "/avatar/05.jpg", mail: "userQ1R1Adresse@mail.com", password: "userQ1R1Password")
			userQ1R1.save()
			...
			responseQ1R1.save()
				// Commentaire Q1R1C1
				User userQ1R1C1 = new User(name: "userQ1R1C1Name", avatarUrl: "/avatar/06.jpg", mail: "userQ1R1C1Adresse@mail.com", password: "userQ1R1C1Password")
				userQ1R1C1.save()
				...
				// Commentaire Q1R1C2
				User userQ1R1C2 = new User(name: "userQ1R1C2Name", avatarUrl: "/avatar/07.jpg", mail: "userQ1R1C2Adresse@mail.com", password: "userQ1R1C2Password")
				userQ1R1C2.save()
			...
			responseQ1R2.save()
				// Commentaire Q1R2C1
				User userQ1R2C1 = new User(name: "userQ1R2C1Name", avatarUrl: "",mail: "userQ1R2C1Adresse@mail.com", password: "userQ1R2C1Password")
				userQ1R2C1.save()
				...
				// Commentaire Q1R2C2
				User userQ1R2C2 = new User(name: "userQ1R2C2Name",avatarUrl: "", mail: "userQ1R2C2Adresse@mail.com", password: "userQ1R2C2Password")
				userQ1R2C2.save()
		...
		questionQ2.save()
				...
				tagQ2T2.save()
				// Commentaire Q2C1
				User userQ2C1 = new User(name: "userQ2C1Name", avatarUrl: "/avatar/09.jpg", mail: "userQ2C1Adresse@mail.com", password: "userQ2C1Password")
				userQ2C1.save()
				...
				// Commentaire Q2C2
				User userQ2C2 = new User(name: "userQ2C2Name",avatarUrl: "/avatar/10.jpg",  mail: "userQ2C2Adresse@mail.com", password: "userQ2C2Password")
				userQ2C2.save()
			...
			// Reponse Q2R1
			User userQ2R1 = new User(name: "userQ2R1Name",avatarUrl: "/avatar/11.jpg",  mail: "userQ2R1Adresse@mail.com", password: "userQ2R1Password")
			userQ2R1.save()
			...
			responseQ2R1.save()
				// Commentaire Q2R1C1
				User userQ2R1C1 = new User(name: "userQ2R1C1Name", avatarUrl: "/avatar/02.png", mail: "userQ2R1C1Adresse@mail.com", password: "userQ2R1C1Password")
				userQ2R1C1.save()
				...
				// Commentaire Q2R1C2
				User userQ2R1C2 = new User(name: "userQ2R1C2Name", avatarUrl: "", mail: "userQ2R1C2Adresse@mail.com", password: "userQ2R1C2Password")
				userQ2R1C2.save()
			...
			// Reponse Q2R2
			User userQ2R2 = new User(name: "userQ2R2Name",avatarUrl: "http://icons.iconarchive.com/icons/deleket/sleek-xp-software/256/Yahoo-Messenger-icon.png", mail: "userQ2R2Adresse@mail.com", password: "userQ2R2Password")
			userQ2R2.save()
			...
			responseQ2R2.save()
				// Commentaire Q2R2C1
				User userQ2R2C1 = new User(name: "userQ2R2C1Name", avatarUrl: "",mail: "userQ2R2C1Adresse@mail.com", password: "userQ2R2C1Password")
				userQ2R2C1.save()
				...
				// Commentaire Q2R2C2
				User userQ2R2C2 = new User(name: "userQ2R2C2Name",avatarUrl: "/avatar/06.jpg", mail: "userQ2R2C2Adresse@mail.com", password: "userQ2R2C2Password")
				userQ2R2C2.save()
		...
		User JJ = new User(name: "Jean63",admin: false, avatarUrl: "",mail: "jean-retyui@outlook.com", password: "ufdfdiop")
		JJ.save()
