        ...
        <div id="content">
			...
			<div style="width: 625px;" id="mainbar">
        		...
        		<g:form id="monForm" url="[controller: 'user', action: 'create']">
	        		<g:textField id="username" name="username" value="Enter a username"/>&nbsp;<label for="username" id="labUser"></label><br>
	        		<g:textField id="profile" name="profile" value="profile picture html link" />&nbsp;<label for="profile" id="labProfile"></label><br>
	        		<g:textField id="mail" name="mail" value="Enter your email" />&nbsp;<label for="mail" id="labMail"></label><br>
	        		<g:textField id="password1" name="password1" value="type a password" /><br>
	        		<g:textField id="password2" name="password2" value="retype your password" />&nbsp;<label for="password2" id="labPassword"></label><br>
