<head>
    <title><g:message code="user.edit.editaccount" /> - Stack Overflow</title>
...
<body style="cursor: default;" class="login-page">
    <div class="container">
        ...
        <div id="content">
        	<div class="subheader">
        	    <h1><g:message code="user.edit.editaccount" /></h1>
			</div>
			<div style="width: 625px;" id="mainbar">
				<div class="page-description">
        		<g:message code="user.edit.tips" />
        		<form id="monForm" class="post-form" method="post" action="/StackOverlow/user/edit">
					...
					<label id="labMessage" for="submit-button" style="color:red">${message }</label><br>
									<input id="submit-button" type="submit" tabindex="120" value="${g.message(code: "user.edit.editaccount")}"></input>
